 ...
 * @property {Array<Schema.Publisher>=} publishers - The rules for publishing a notification. This is optional. In most cases, it's best to rely on the default rules bound to the alert's owner.
 ...
 * @property {Boolean} read - shows whether the alert has been read.
 */
 ...
 * @type Object
 * @memberOf Schema
 * @property {Number} operator_id - The operators's unique identifier (assigned by the backend).
...
/**
 * Describes the type of an alert trigger status.
 *
 * @typedef AlertTriggerStatus
 * @type Object
 * @memberOf Schema
 ...
 * @property {String} trigger_status - The status of the trigger.
 * @property {String} trigger_status_date - The last time the alert trigger status was updated.
 * @property {String} trigger_name - The name of the trigger.
 */