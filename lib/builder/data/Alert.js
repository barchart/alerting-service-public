module.exports = (() => {
	 ...
	 * @param {Alert<Subscribers>} schedules - An array of subscribers
	 */
	class Alert {
		constructor(name, userId, alertSystem, alertType, alertBehavior, conditions, publishers, schedules, automaticReset, userNotes) {
