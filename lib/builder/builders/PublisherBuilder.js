...
module.exports = (() => {
	...
	class PublisherBuilder {
		...
		withRecipient(recipient) {
			...
			this._publisher = new Publisher(recipient, this._publisher._type, this._publisher._format, this._publisher._use_default_recipient);
		...
		withFormat(format) {
			...
			this._publisher = new Publisher(this._publisher._recipient, this._publisher._type, format, this._publisher._use_default_recipient);
		...
		withUseDefaultRecipient() {
			this._publisher = new Publisher(this._publisher._recipient, this._publisher._type, this._publisher._format, true);
